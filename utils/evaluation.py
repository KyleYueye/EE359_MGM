...
def get_cp(cluster, cluster_gt, num_clusters, num_graphs):
    tot = 0
...
def get_ri(cluster, cluster_gt, num_clusters, num_graphs):
    tot = 0
    tp = 0
...
def get_ca(cluster, cluster_gt, num_clusters, num_graphs):
    ca = 0
